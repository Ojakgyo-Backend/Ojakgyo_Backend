...
public class LockerService {
    ...
    public Locker createLocker(String address, String password) {
        Locker locker = Locker.builder().lockerStatus(LockerStatus.NOT_IN_USE).address(address).password(password).createLockerPwdAt(LocalDateTime.now()).build();
    ...
    public List<SearchLockerResponse> findAll() {
        ...
        for (Locker locker : lockerList) {
            SearchLockerResponse searchLockerResponse = SearchLockerResponse.builder().lockerId(locker.getId()).address(locker.getAddress()).build();
    ...
    public List<SearchLockerResponse> findByAddress(String address) {
        ...
        for (Locker locker : findLocker) {
            SearchLockerResponse searchLockeresponse = SearchLockerResponse.builder().lockerId(locker.getId()).address(locker.getAddress()).build();
    ...
    public boolean checkPassword(Long lockerId, String password) {
        ...
        return password.equals(locker.getPassword());
