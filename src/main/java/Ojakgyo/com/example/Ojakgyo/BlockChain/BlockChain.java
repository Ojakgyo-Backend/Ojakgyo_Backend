...
public class BlockChain {
    ...
    public BlockChainContract getContract(Long dealId) throws Exception {
        ...
        try (Gateway gateway = builder.connect()) {
            ...
            Network network = gateway.getNetwork("channal1");
...
//
//        CryptoPrimitives crypto = new CryptoPrimitives();
//        Identity user = Identities.newX509Identity(mspId, (X509Identity) userObject.getString("cert"), crypto.bytesToPrivateKey(Base64.getDecoder().decode(userObject.getString("key"))));
//        wallet.put(userId,user);
//
//        Gateway.Builder builder = Gateway.createBuilder()
//                .identity(wallet, userId)
